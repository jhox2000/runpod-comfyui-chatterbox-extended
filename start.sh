#!/bin/bash
# ============================================================================
# start.sh — Template RunPod 1-CLICK: ComfyUI Wan 2.2 I2V + Chatterbox Multilingual
# ----------------------------------------------------------------------------
...
# GPU alvo: RTX 5090 (Blackwell sm_120) ou superior.
# Portas HTTP: 7860 (Chatterbox) | 8188 (ComfyUI) | 8888 (JupyterLab)
# Tempo de boot estimado: ~15-20 min (download de ~35GB de modelos).
# ============================================================================
set -e
...
# ----------------------------------------------------------------------------
# (4/6) Chatterbox-TTS-Extended (multilingual)
# ----------------------------------------------------------------------------
if [ ! -d /workspace/Chatterbox-TTS-Extended ]; then
    echo "[boot] (4/6) Instalando Chatterbox-TTS-Extended..."
    cd /workspace
...
PYPATCH
    ...
    # ---- (5/6) Gravar o Chatter.py JA PATCHEADO (multilingual) ----
    echo "[boot] (5/6) Gravando Chatter.py patcheado (multilingual)..."
...
echo "[boot] (6/6) Iniciando Chatterbox-TTS-Extended na porta 7860..."
